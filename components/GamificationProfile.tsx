        ...
        <div className="px-5 pt-6 pb-8 bg-slate-50 border-b border-slate-100 rounded-b-[2.5rem]">
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={() => onViewChange(ViewType.HOME)} className="p-2 bg-white shadow-sm border border-slate-200 rounded-xl hover:bg-red-50 hover:text-red-500 transition-colors">
                ...
                {isEditing && (
                    <div className="animate-in slide-in-from-top-4 duration-300 space-y-6 bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
                        ...
                        <button 
                            ...
                            className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest flex items-center justify-center gap-2 shadow-xl active:scale-95 transition-all"
                        >
